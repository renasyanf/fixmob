...
class ServiceOli extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  child: Image.asset(
                    'assets/images/oli.png', // Replace with your oil image path
                    fit: BoxFit.cover,
                  ),
                ),
                SizedBox(width: 16),
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color(0xFF6C3A10), // Use backgroundColor instead of primary
            ...
            DefaultTabController(
              length: 3, // Terkait, Terbaru, Terlaris
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  TabBar(
                  ...
                  SizedBox(
                    height: 150, // Set height for the tab view content
                    child: TabBarView(
                      children: [
            ...
            Center(
              child: ElevatedButton(
                onPressed: () {
                  // Handle "Tampilkan lebih banyak" action
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color(0xFF6C3A10), // Use backgroundColor instead of primary
                  shape: RoundedRectangleBorder(
  ...
  Widget _buildSparepartList() {
    return ListView(
      ...
      children: [
        _sparepartCard(
            'Oli Shell Helix Ultra 5W - 30', 'assets/images/oli_shell.png'),
        _sparepartCard(
            'Oli Mobil 1 5W - 30', 'assets/images/mobil_oli.png'),
        _sparepartCard(
            'Oli Castrol Edge 5W - 30', 'assets/images/castrol_oli.png'),
      ],
    );
  }
